...
gantt
    ...
    迭代4：测试验收与上线准备      :milestone, iter4, after iter3, 7d
    ...
    section 新增迭代阶段(移动端 后2周)
    迭代5：手机端开发与权限调整    :milestone, iter5, after iter4, 14d
    移动端架构搭建&环境配置        :iter5_1, 2026-05-06, 2d
    安卓端核心功能(填报/上报)    :iter5_2, after iter5_1, 4d
    iOS端核心功能(填报/上报)      :iter5_3, after iter5_2, 4d
    PC/移动端数据同步接口开发      :iter5_4, after iter5_2, 3d
    移动端权限规则配置&联调        :iter5_5, after iter5_3, 1d

    迭代6：更改需求验收与整体上线  :milestone, iter6, after iter5, 7d
    移动端全流程测试&bug修复      :iter6_1, after iter5_5, 3d
    全系统(PC+移动端)联调测试    :iter6_2, after iter6_1, 2d
    最终上线部署&全员培训          :iter6_3, after iter6_2, 2d

    section 角色负责人维度
    后端开发(架构/接口/优化)     :back, 2026-04-01, 42d
    前端开发(页面/交互/可视化)   :front, 2026-04-01, 42d
    移动端开发工程师               :mobile, 2026-05-06, 28d
    测试工程师(全流程测试/验收)  :test, 2026-04-01, 42d
    运维工程师(环境/部署/运维)   :ops, 2026-04-01, 60d
    产品/文档专员(需求/文档/培训):product, 2026-04-01, 42d
    项目负责人(统筹/协调/验收)   :pm, 2026-04-01, 60d

```
系统使用：http://localhost:8080/
